...
class ConsumoBase(BaseModel):
    ...
    comidas_consumidas: List[str]  # IDs de comidas
...
class FeedbackEstadisticas(BaseModel):
    promedio_calificacion: float
    total_feedback: int
    calificaciones_por_nivel: dict  # {1: count, 2: count, ...}
    feedback_recientes: List[FeedbackResponse]
